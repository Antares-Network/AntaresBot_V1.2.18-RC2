...
class Command {
	...
	hasPermission(message, ownerOverride = true) {
		...
		if (this.ownerOnly && (ownerOverride || !this.client.isOwner(message.author))) {
			console.log(`Checking BotOwner:`.red, `${message.author.username}`.yellow, `FALSE`.red);
	...
	onBlock(message, reason, data) {
		switch (reason) {
			...
			case 'permission': {
				...
				console.log(`ERROR. `.red, `${message.author.username} tried to use command: ${this.name}, but did not have the correct permission`);
				return;
			}
